...
class Trainer(object):
    ...
    def forward(self, color_heightmap, depth_heightmap, is_volatile=False, specific_rotation=-1):
        # print("depth_heightmap.size():", depth_heightmap.shape)
        # depth_heightmap.size(): (224, 224)
        ...
        # print("input_depth_image.size():", input_depth_image.shape)
        # input_depth_image.size(): (640, 640, 3)
